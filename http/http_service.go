...
func (httpSvc *HttpService) RegisterSharedRoutes(e *echo.Echo) {
	...
	e.Use(middleware.SecureWithConfig(middleware.SecureConfig{
		...
		XFrameOptions:         "DENY",
		ContentSecurityPolicy: "default-src 'self'; img-src 'self' https://uploads.getalby-assets.com https://getalby.com; connect-src 'self' https://api.getalby.com https://getalby.com https://zapplanner.albylabs.com; frame-src https://embed.bitrefill.com",
